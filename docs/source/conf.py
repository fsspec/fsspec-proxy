...
version = fsspec_proxy.__version__
# The full version, including alpha/beta/rc tags.
release = fsspec_proxy.__version__
...
extlinks = {
    "issue": ("https://github.com/fsspec-proxy/filesystem_spec/issues/%s", "GH#%s"),
    "pr": ("https://github.com/fsspec-proxy/filesystem_spec/pull/%s", "GH#%s"),
}
